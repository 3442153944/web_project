...
<script setup>
let img_path=ref('https://www.sunyuanling.com/image/thumbnail/65014220_p0.jpg');
let novel_info=ref({
    state:'单篇完结作品',
    title:'作品标题',
    useravatar:'https://www.sunyuanling.com/image/avatar_thumbnail/100213135_p1.jpg',
    username:'用户名',
})
