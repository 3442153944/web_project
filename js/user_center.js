...
Vue.component('collect_work_info_box',{
    props:[
'jump_imgpage','setpublic_btn','setpublic','setcollection_btn','setcollection','settag','settag_btn','showsubusercenter','hidesubusercenter',
'items'],
data:function(){
    return {
    ...
    <div class="switch_box_content_2_content_1_page_content_box">
        <div class="switch_box_content_2_content_1_page_content_box_img">
            ...
            <div class="switch_box_content_2_content_1_page_content_box_img_moreico">
                <svg t="1713083347358" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="9142" width="200" height="200">
                    <path
            ...
            <div class="switch_box_content_2_content_1_page_content_box_img_love">
                <div v-show="switch_box_content_2_love_show_1"
                    @click="switch_box_content_2_love_show_1_btn1">
                    <svg t="1713083415377" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="10166" width="200" height="200">
                        <path
                ...
                <div v-show="switch_box_content_2_love_show_2"
                    @click="switch_box_content_2_love_show_1_btn1">
                    <svg t="1713085520923" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="12188" width="200" height="200">
                        <path
            ...
            <div class="switch_box_content_2_content_1_page_content_box_img_edit">
                <div class="switch_box_content_2_content_1_page_content_box_img_edit_icon" @click="edit_imglook1">
                    <svg t="1713083480072" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="11165" width="200" height="200">
                        <path
            ...
            <div class="switch_box_content_2_content_1_page_content_box_img_back" @click="jump_imgpage">

            </div>
        </div>
        <div class="switch_box_content_2_content_1_page_content_box_title" v-show="content_box_title">
            <div class="switch_box_content_2_cont_1_page_content_box_title_setpublic mt hv" @click="setpublic_btn">{{setpublic}}</div>
            <div class="switch_box_content_2_content_1_page_content_box_title_setcollection mt hv " @click="setcollection_btn">{{setcollection}}</div>
            <div class="switch_box_content_2_content_1_page_content_box_title_settag mt hv" @click="settag_btn">{{settag}}</div>
        </div>
        <div class="switch_box_content_2_content_1_page_content_box_userbox" @mouseenter="showsubusercenter" @mouseleave="hidesubusercenter">
            ...
            <div class="switch_box_content_2_content_1_page_content_box_userbox_author_introduction" v-show="author_introduction_show">
                <div class="sub_main_usercenter">
                    ...
                    <div class="sub_main_usercenter_selected_works_box">
                        <sub-main-usercenter-selected-works v-for="(item, index) in items" :key="index" :item="item"></sub-main-usercenter-selected-works>
                    </div>
